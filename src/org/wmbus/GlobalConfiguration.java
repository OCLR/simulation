...
public class GlobalConfiguration {
    public static final int NETWORK_SIZE_METERS =  10000; // 10 km.
    public static final int MAX_NODE_RADIUS = 1500 ; // 1,5kM
    public static final int MIN_NODE_RADIUS = 100 ; // 100meter
